...
namespace MantaRayShoal
{
    ...
    public class MantaNPCInteraction : MonoBehaviour
    {
        ...
        public string talkAnimationState = "Talking";
        ...
        [Tooltip("If true, interacting with this NPC will start the quest")]
        ...
        private void StartTalking()
        {
            ...
            if (startsQuestOnInteraction && MantaQuestManager.Instance != null)
            {
                MantaQuestManager.Instance.StartQuest();
            }
        }
